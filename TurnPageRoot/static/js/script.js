...
if (signupFields) {
    ...
    signupFields[1].placeholder = 'Username'
    signupFields[2].placeholder = 'Email'
    signupFields[3].placeholder = 'Password'
    signupFields[4].placeholder = 'Confirm Password'
    signupFields[5].placeholder = 'Captcha'
}
