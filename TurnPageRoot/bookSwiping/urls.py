...
urlpatterns = [
    ...
    path("bookshelf/move_to_saved_books", views.move_to_saved_books, name="move_to_saved_books"),
    path("bookshelf/move_to_liked_books", views.move_to_liked_books, name="move_to_liked_books"),
